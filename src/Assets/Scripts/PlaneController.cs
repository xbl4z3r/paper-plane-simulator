...
public class PaperController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if(_rb.velocity.magnitude > 3.5f && !_onGround) transform.rotation = Quaternion.Lerp(transform.rotation, Quaternion.LookRotation(_rb.velocity), Time.deltaTime * 20f);
